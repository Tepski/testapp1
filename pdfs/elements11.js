const text = `1. Are bevel gears mounted on intersecting shafts at angle of other than 90?. 
A. right angle gears  
...
ANSWER: D 
2. Is one in which the pitch angle is 90? that is, the pitch cone has become a plane. 
...
ANSWER: C 
6. The contact ratio of pair of mating spur gears must be well 
over____ to insure a smooth transfer of load from one pair of teeth to the next pair. 
...
ANSWER: D 
12. Well proportioned commercial gears with a pitch line velocity of less than_____ will normally not score if they have a reasonably good surface finish and are properly lubricate
d. 
A. 6000 fpm 
...
ANSWER: B 
13. Experimental data from actual gear unit measurements are 
seldom repeatable within a plus or minus____ band 
...
ANSWER: D 
19. For internal gears having a 20? pressure angle and full depth teeth, the difference between the number of teeth in a gear and pinion should not less than ____. 
...
ANSWER: B 
25. Is the angle through which the gear turns from the time a 
given  pair of teeth are in contact at the pitch point until they pass out the mesh. 
A. angle of contact 
...
ANSWER: D 
26. Is the angle through which the gear turns from the time a 
particular pair of teeth come into contact until they go out the contact. 
A. pitch angle  
...
ANSWER: B 
27. Is the angle through which the gear turns form the time a 
particular pair of teeth come into contact until they are in contact at the pitch point.   
...
ANSWER: B 
33. The circle from which an involute tooth is generated or develope
d. 
A. Pitch circle  
...
D. angular plane 
ANSWER: B 
40. Length of the chord subtended by the circular thickness ar
c. 
...
ANSWER: A 
41. The height from the top of the tooth to the chord subtending the circular- thickness ar
c. 
...
ANSWER: D 
47. Also known as tooth thickness or the length of the arc between the two sides of a gear tooth, on the pitch circles unless otherwise specifie
d. 
A. tooth thickness 
...
ANSWER: D 
66. That surface which is between the pitch circle and the bottom lan
d. 
A. flank 
...
ANSWER: D 
83.	The distance between similar, equally spaced tooth 
surfaces, in a given direction and along a given curve or line.   
...
ANSWER: B 
88. In a pair of gears it is the plane perpendicular to the axial plane and tangent to the axial plane and tangent to the pitch surfaces. 
A. addendum plane  
...
D. none of these  
ANSWER: C 
101. The intensity of stress that causes unit strain is known as: 
...
ANSWER: D 
102. For steel, the ultimate strength in shear as compared to in tension is nearly: 
...
ANSWER: B 
103. Select the one that has no unit: 
...
ANSWER: D 
104. When a part is constrained to move and heated, it develops: 
...
ANSWER: C 
105. The tensile stress of a material is given by: 
...
ANSWER: A 
106. The size of hole that is drilled in plates for 
...
D. 1.5 to 2 mm larger than the diameter of the rivet for 
rivets of 25 mm and above size 

ANSWER: D 
107. The horsepower that can be transmitted by a shaft 60 mm diameter at 180 rpm with permissible shear stress of 850 kg/cm2 shall be approximately: 
...
ANSWER: C 
108. A column is called short column when: 
...
ANSWER: C 
109. Which one is the correct statement about true stress-strain method? 

A. There is no such phenomenon like true stress or true strain. 

B. True stress is load per unit area(actual) and similarly true strain is determined under actual conditions. 
C. This method can be used for compression test as well 

D. lt is more sensitive to changes in mechanical 

ANSWER: A 
110.	The total strain energy stored in a body is called: 
...
ANSWER: A 
111. A material that is capable of absorbing a large quantity of energy before fracture is called: 
...
successively 
ANSWER: D 
113. Two shafts made up of mild steel one having circular cross section and the other being hollow circular with inner diameter half of the outer diameter. The ratio of the torque that can be transmitted in two cases given by: 
...
ANSWER: D 
114. For a circular shaft subjected to torque the value of shear stress Is equal to: 
...
ANSWER: D 
115. In laminated spring the strips are provided in different lengths for: 
...
ANSWER: D 
116. Select the one for which diamond riveted joint can be adopted; 
A. Butt joint 
...
ANSWER: D 
118. Modulus of rigidity can be defined as the ratio of: 
...
119.	1 Mega newton per square meter is equal to: 
...
ANSWER: D 
120. The value of shear stress changes is induced in the shaft because of the applied couple that: 
...
ANSWER: B 
121. In the design of pulley, key and shaft: 
...
ANSWER: B 
122. The radial pressure and hoop tension for a thick cylinder is: 
...
ANSWER: A 
123. Autofrettage is the method of: 
...
ANSWER: C 
124. Ties are load carrying members that carry: 
...
ANSWER: C 
125. If the areas of cross sections of square and circular beams are same and both are put to equal bending moment, then the correct statement is: 
