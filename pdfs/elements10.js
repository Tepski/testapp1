const text = `1. A key that allows the hub to move along the shaft but prevents the rotation of the shaft. 
...
ANSWER: B 
5. A coupling that transmits power via the frictional forces induced by pulling the flanges toward each other over slotted tapered sleeves. 
A. flange coupling 
...
ANSWER: D 
6. A coupling used for absorbing some shock and vibration that may appear on one shaft and of preventing the occurrence of reversed stresses caused by the shaft deflecting at the coupling. 
A. rigid coupling  
...
ANSWER: D 
11. Is one in which the radii of the journal and the bearing are the same. 
...
ANSWER: A 
12. The line that passes through the centers of the bearing and the journal is called the 
...
ANSWER: D 
16. At higher temperatures, the oil oxidizes, more rapidly above 
A. 120�F 
B. 140�F 
C. 160�F 
...
ANSWER: A 
18. The following are considered advantageous for bearing materials include 
A. conformability 
...
ANSWER: B 
27. The breaking strength of oak-tanned belting varies from 3 to more than 
A. 5 ksi 
B. 7 ksi 
C. 6 ksi 
...
ANSWER: A 
30. Experience suggests that the most economical designs are obtained for a belt speed of 
A. 4000 to 4500 fpm 
B. 2000 to 3000 fpm 
C. 3000 to 4000 fpm 
...
ANSWER: D 
33. On high speed centrifugal blowers, it has been observed that the arc of contact reduced from 180� at rest to ____ in motion. 
A. 100� 
...
ANSWER: B 
36. If two intersecting shafts are to be belt connected, ____ guide pulleys are to be use
d. 
...
ANSWER: D 
38. The minimum number of teeth on the smaller sprocket for low speeds is 
A. 12 
B. 16 
C. 14 
...
ANSWER: C 
40. The minimum number of teeth on the smaller sprocket for high speeds is 
A. 19 
B. 21 
C. 23 
...
ANSWER: B 
41. Wire ropes are made from cold-drawn wires that are first wrapped into ____. 
A. layer 
...
ANSWER: C 
42. For maximum quietness, use sprockets with ____ or more teeth. 
A. 21 
B. 25 
C. 23 
...
ANSWER: D 
43. A wire rope that wires and strands are twisted in opposite direction 
A. long lay 
...
ANSWER: C 
44. A wire rope that the wires and strands are twisted in the same direction 
A. long lay 
...
ANSWER: A 
54. Friction devices used to regulate the motion of bodies and with clutches. 
A. roller 
...
ANSWER: A 
61. The brake lining operating at temperature ____, sintered mixtures containing ceramics are use
d. 
...
ANSWER: B 
65. A welding operation that use hot flame and metal ro
d. 
...
ANSWER: A 
68. For best running conditions of gear, the contact ratio should be about 
A. 1.25 to 1.4 
...
ANSWER: B 
73. Is caused by foreign matter, such as grit or metal particles, or by a failure of the oil film at low spee
d. 
...
ANSWER: D 
75. Is a surface fatigue of greater extent than pitting; that is the flakes are much larger. This type of failure occurs in surfacehardened teeth. 
A. abrasion 
...
ANSWER: B 
77. The extra tooth in gear which is use to distributes the wear more evenly. 
A. hunting tooth 
...
ANSWER: D 
83. Is the advance of the tooth in the face with divided by circular pitch. 
...
ANSWER: B 
87. Are used to connect intersecting shafts, usually but not necessarily at 90�. 
A. spur gear 
...
ANSWER: D 
97. When the pitch line speed is above 8000 fpm, the teeth should be ____. 
...
ANSWER: A 
98. ____ have curved teeth, as in spiral bevels, but with zero spiral angle. 
A. spiral gear 
...
ANSWER: B 
99. A gear that has an advantage of smoother tooth engagement, quietness of operation, greater strength, and higher permissible speeds. 
A. zerol bevel gear 
...
ANSWER: C 
106. In the usual spur gearing, the: 
...
ANSWER: D 
108. The use of mixtures (hydrated lime, fly ash, etc.) with concrete is to _____. 
A. reduce weight 
...
ANSWER: C 
109. Stainless steel is obtained principally be the used of which alloying elements: 
A. chromium 
...
ANSWER: B 
112. One of the following metals which respond to heat treatment: 
A. cast iron 
...
ANSWER: C 
117. The kind of center which is being attached and meshed to the tailstock spindle which is also static while the work is rotating is: 
A. dead center 
...
ANSWER: D 
119. During the quenching process in heat treating steel, agitation of the fluids used in the quenching has what effect on the severity of the quenching? 
...
ANSWER: D 
121. When a solid cube is subjected to equal normal forces of the same type on all its faces. The ratio of volumetric strain/linear strain along any of the three axes will be equal to: 
A.	1 
B.	2 
C.  3  	
D.	3 
