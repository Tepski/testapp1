...
import elements1 from "../pdfs/elements9";
import elements2 from "../pdfs/elements10";
import elements3 from "../pdfs/elements11";
import elements4 from "../pdfs/elements12";
...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <View
      ...
      className="flex-1 px-4 justify-center items-center py-4 bg-background"
    >
      <Text
        className="text-3xl text-text my-4 font-semibold"
        // onPress={() => navigation.navigate("Admin")}
      >
        MDSP WEEK 9 ELEMENTS
      </Text>
                ...
                {number == index && (
                  ...
                  >
                    <View className="flex-row items-center justify-between w-full">
                      <Text className="text-xl font-semibold">Randomize</Text>
                      <Switch
                        thumbColor={"#c72323"}
                        trackColor={"white"}
                        value={options.random}
                        onChange={() =>
                          setOptions({ ...options, random: !options.random })
                        }
                      />
                    </View>
