...
D. minimum 
ANSWER: C
 7. When tested in compression, ductile materials usually exhibit characteristics up to the yield strength as they when tested in tension. 
A. the same 
B. less than 
C. more than 
...
D. unit system 
ANSWER: B
 17. When the hole is smaller than the shaft, it will take force or pressure to put the cold parts together. The allowance is said to be negative and is termed as the 
...
ANSWER: D
 23. It has been said that 80% of the failures of machine parts have been 
A. negligence  
B. compression  
C. torsion  
D. fatigue failures 
...
D. control stress 
ANSWER: A
 29. Is a process of prestressing or over-stressing a hollow cylindrical member beyond the elastic range by hydraulic pressure 
A. pressttage 
B. stress relieving  
C. autofrettage 
D. countersinking 
ANSWER: C
 30. When two touching surfaces have a high contact pressure and when these surfaces have minute relative motion, a phenomenon called 
A. prestressing 
B. friction  
C. carving 
D. fretting 
ANSWER: B
 31. Is the process that cold works a limited amount of material, thus giving a higher strength, and it leaves a surface compressive stress. 
A. surface finishing  
B. smoothing 
C. surfacing   
D. surface rolling 
...
D. relieving 
ANSWER: B
 34. Is the diameter of the imaginary cylinder that bounds the crest of an external thread and the roots of an internal thread. 
A. mean diameter  
B. stress diameter 
C. minor diameter 
D. major diameter 
ANSWER: D
 35. Is the distance in inches a screw thread (a helix) advances axially in one turn. 
A. lead 
B. circular pitch    
C. pitch   
D. mean pitch 
...
D. NC   
ANSWER: B
 39. Is used on bolts for high-pressure pipe flanges, cylinder head studs etc. 
A. UNC 
B. UNEF 
C. UNF 
D. 8 UN 
ANSWER: D
 40. Then stress or load induced by the tightening operation  
A. initial stress  
B. residual stress  
C. initial tension 
D. none of these 
...
D. screw 
ANSWER: D
 44. An old name for an unfinished through bolt, comes with a square. 
A. coupling bolt 
B. machine bolt 
C. stud bolt 
D. automobile bolt 
ANSWER: B
 45. Is a type of bolt finished all over, usually having coarse threads. 
A. coupling bolt  
B. machine bolt  
C. stud bolt  
D. automobile bolt 
ANSWER: A
 46. Is a type of bolt distinguished by a short portion of the shank underneath the head being square or finned or ribbed. 
A. coupling bolt 
B. machine bolt  
C. stud bolt  
D. carriage bolt 
...
ANSWER: D
 55. It is the ratio of mean diameter of coil over the coil diameter. 
A. Waahl factor   
B. diameter ratio  
C. spring index  
D. lead angle 
...
D. 10% 
ANSWER: A
 59. When heat-treated wire is coiled cold, it should be stress relieved for bending stresses after cooling by being heated at some ____. 
A. 400% 
B. 700% 
C. 600% 
D. 500% 
ANSWER: D
 60. Is a low cost spring material, suitable where service is not severe and dimensional precision is not needed.  
A. hard drawn wire spring   
B. helical spring wire 
C. stainless steel 
D. helical tension spring wire 
ANSWER: A
 61. Is a hard drawn also (80%reduction), but it is made of high grade steel. 
A. music wire 
B. oil tempered wire 
C. song wire 
...
D. helical tension spring wire 
ANSWER: C
 63. Is a type of coil where the helical coil is wrapped into a circle forming an annual ring 
A. volute spring  
B. motor spring 
C. hair spring  
D. garter spring 
...
D. triaxial 
ANSWER: D
 72. Under theories of failure, for static loading of ductile material, the design stress is 
...
D. 3 times 
ANSWER: C
 74. The theory of mechanics of materials shows that the results from the octahedral shear stress theory and those from the maximum distortion-energy theory are 
A. relevant  
B. less than 
C. the same 
D. more than 
...
D. vertical angle 
ANSWER: C
 77. For ACME thread the pressure angle normal to the thread is 
A. 12.5� 
B. 14.5� 
C. 13.5� 
D. 34� 
...
D. head shaft 
ANSWER: C
 84. Is the shaft intermediate between a line shaft and a driven shaft 
A. countershafts 
B. jackshafts 
C. headshafts 
D. all of these 
...
D. 25 
ANSWER: B
 89. An old rule of thumb for transmission shafting is that the deflection should not exceed ____ of length between supports. 
A. 0.01 in per foot  
B. 0.03 in per foot  
C. 0.02 in per foot 
D. 0.04 in per foot 
...
D. 0.003 in 
ANSWER: D
 92. The speed at which the center of mass will be equal the deflecting forces on the shaft; the shaft with its attached bodies will then vibrate violently, since the centrifugal force changes its direction as the shaft turns is 
A. mean speed 
B. critical speed 
C. geometric speed 
D. unit speed 
ANSWER: B
 93. For shaft, the minimum value of numerical combined shock and fatigue factor to be applied in every case to the computed bending moment is 
A. 1.0 
B. 1.5 
C. 1.3 
D. 1.8 
...
ANSWER: B
 106. Gears used to transmit power between shafts axis of which intersect: 
A. spur gear 
B. bevel gear 
C. helical gear 
...
D. width 
ANSWER: D
 109. An iron in which most of the carbon is chemically combined with the iron: 
A. cast iron 
B. gray iron 
C. white iron 
D. malleable iron 
...
D. sociability 
ANSWER: C
 116. Which of the following metals is non-magnetic? 
A. manganese steel 
B. cast steel 
C. alloy steel 
D. cast iron 
